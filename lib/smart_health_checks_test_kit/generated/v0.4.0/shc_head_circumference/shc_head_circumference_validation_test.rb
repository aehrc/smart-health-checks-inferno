...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040
    class ShcHeadCircumferenceValidationTest < Inferno::Test
      ...
      id :smart_health_checks_v040_shc_head_circumference_validation_test
...
fail if their code/system are not found in the valueset.
      ...
      def filter_set
        [[{ 'expression' => "code.coding.where(system = 'http://loinc.org').code", 'value' => '9843-4' }], [{ 'expression' => "code.coding.where(system = 'http://snomed.info/sct').code", 'value' => '363812007' }]]
      end
