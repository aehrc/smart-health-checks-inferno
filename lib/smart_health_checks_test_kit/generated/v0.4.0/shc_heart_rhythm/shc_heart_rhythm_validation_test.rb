...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040
    class ShcHeartRhythmValidationTest < Inferno::Test
      ...
      id :smart_health_checks_v040_shc_heart_rhythm_validation_test
...
fail if their code/system are not found in the valueset.
      ...
      def filter_set
        [[{ 'expression' => "code.coding.where(system = 'http://loinc.org').code", 'value' => '8884-9' }], [{ 'expression' => "code.coding.where(system = 'http://snomed.info/sct').code", 'value' => '364074009' }]]
      end
