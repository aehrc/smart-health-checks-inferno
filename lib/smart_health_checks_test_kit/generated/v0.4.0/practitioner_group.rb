...
read succeeds.
      ...
      test from: :smart_health_checks_v040_practitioner_read_test
      test from: :smart_health_checks_v040_practitioner_validation_test
      test from: :smart_health_checks_v040_practitioner_must_support_test
    end
  end
end
