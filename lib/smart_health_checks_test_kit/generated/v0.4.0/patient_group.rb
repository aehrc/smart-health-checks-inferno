...
read succeeds.
      ...
      test from: :smart_health_checks_v040_patient_read_test
      test from: :smart_health_checks_v040_patient_validation_test
      test from: :smart_health_checks_v040_patient_must_support_test
    end
  end
end
