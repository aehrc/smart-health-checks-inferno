...
read succeeds.
      ...
      test from: :smart_health_checks_v040_shc_heart_rhythm_patient_search_test
      test from: :smart_health_checks_v040_shc_heart_rhythm_code_search_test
      test from: :smart_health_checks_v040_shc_heart_rhythm_patient_code_search_test
      test from: :smart_health_checks_v040_shc_heart_rhythm_validation_test
      test from: :smart_health_checks_v040_shc_heart_rhythm_must_support_test
      test from: :smart_health_checks_v040_shc_heart_rhythm_reference_resolution_test
      test from: :smart_health_checks_v040_shc_heart_rhythm_create_test
    end
  end
end
