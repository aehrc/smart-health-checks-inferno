...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040
    class QuestionnaireResponseStatusSearchTest < Inferno::Test
      ...
      title '(MAY) Server returns valid results for QuestionnaireResponse search by status'
      description %(
...
[Smart Health Checks Server CapabilityStatement](https://smartforms.csiro.au/ig/CapabilityStatement/SHCHostFHIRServerCapabilityStatement)
      ...
      id :smart_health_checks_v040_questionnaire_response_status_search_test
      optional
