...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class ShcHeartRateMustSupportTest < Inferno::Test
      ...
      description %(
        ...
        * Observation.code
        * Observation.code.coding:HeartRateCode
        * Observation.code.coding:snomedHeartRateCode
      ...
      id :smart_health_checks_v040_ci_build_shc_heart_rate_must_support_test
