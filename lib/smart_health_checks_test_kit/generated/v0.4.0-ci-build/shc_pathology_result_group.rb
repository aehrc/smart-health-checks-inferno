...
require_relative 'shc_pathology_result/shc_pathology_result_create_test'
...
read succeeds.
      ...
      id :smart_health_checks_v040_ci_build_shc_pathology_result
      run_as_group
      ...
      test from: :smart_health_checks_v040_ci_build_shc_pathology_result_patient_search_test
      test from: :smart_health_checks_v040_ci_build_shc_pathology_result_code_search_test
      test from: :smart_health_checks_v040_ci_build_shc_pathology_result_patient_code_search_test
      test from: :smart_health_checks_v040_ci_build_shc_pathology_result_validation_test
      test from: :smart_health_checks_v040_ci_build_shc_pathology_result_must_support_test
      test from: :smart_health_checks_v040_ci_build_shc_pathology_result_reference_resolution_test
      test from: :smart_health_checks_v040_ci_build_shc_pathology_result_create_test
    end
  end
end
