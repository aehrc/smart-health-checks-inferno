...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class QuestionnaireResponsePatientStatusSearchTest < Inferno::Test
      ...
      title '(SHALL) Server returns valid results for QuestionnaireResponse search by patient + status'
      description %(
...
[Smart Health Checks Server CapabilityStatement](https://smartforms.csiro.au/ig/CapabilityStatement/SHCHostFHIRServerCapabilityStatement)
      ...
      id :smart_health_checks_v040_ci_build_questionnaire_response_patient_status_search_test
      input :patient_ids,
            title: 'Patient IDs',
