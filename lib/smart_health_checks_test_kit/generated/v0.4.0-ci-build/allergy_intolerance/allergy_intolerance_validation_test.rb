...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class AllergyIntoleranceValidationTest < Inferno::Test
      ...
      id :smart_health_checks_v040_ci_build_allergy_intolerance_validation_test
      title 'AllergyIntolerance resources returned during previous tests conform to the Smart Health Checks AllergyIntolerance'
      description %(
This test verifies resources returned from the first search conform to
the [Smart Health Checks AllergyIntolerance](https://smartforms.csiro.au/ig/StructureDefinition/SHCAllergyIntolerance).
