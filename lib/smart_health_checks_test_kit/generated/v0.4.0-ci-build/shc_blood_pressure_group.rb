...
require_relative 'shc_blood_pressure/shc_blood_pressure_patient_code_search_test'
...
require_relative 'shc_blood_pressure/shc_blood_pressure_create_test'

module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class ShcBloodPressureGroup < Inferno::TestGroup
      title 'Observation Blood Pressure Tests'
      short_description 'Verify support for the server capabilities required by the Smart Health Checks Blood Pressure.'
      description %(
  # Background

The Smart Health Checks Observation Blood Pressure sequence verifies that the system under test is
able to provide correct responses for Observation queries. These queries
must contain resources conforming to the Smart Health Checks Blood Pressure as
...
the [Smart Health Checks Blood Pressure](https://smartforms.csiro.au/ig/StructureDefinition/SHCBloodPressure). Each element is checked against
...
read succeeds.
      ...
      id :smart_health_checks_v040_ci_build_shc_blood_pressure
      run_as_group
      ...
      test from: :smart_health_checks_v040_ci_build_shc_blood_pressure_patient_search_test
      test from: :smart_health_checks_v040_ci_build_shc_blood_pressure_code_search_test
      test from: :smart_health_checks_v040_ci_build_shc_blood_pressure_patient_code_search_test
      test from: :smart_health_checks_v040_ci_build_shc_blood_pressure_validation_test
      test from: :smart_health_checks_v040_ci_build_shc_blood_pressure_must_support_test
      test from: :smart_health_checks_v040_ci_build_shc_blood_pressure_reference_resolution_test
      test from: :smart_health_checks_v040_ci_build_shc_blood_pressure_create_test
    end
  end
end
