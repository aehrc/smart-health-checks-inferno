...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class ShcBodyHeightValidationTest < Inferno::Test
      ...
      id :smart_health_checks_v040_ci_build_shc_body_height_validation_test
...
fail if their code/system are not found in the valueset.
      ...
      def filter_set
        [[{ 'expression' => "$.code.coding[?(@.system == 'http://loinc.org')].code", 'value' => '8302-2' }], [{ 'expression' => "$.code.coding[?(@.system == 'http://snomed.info/sct')].code", 'value' => '50373000' }]]
      end
