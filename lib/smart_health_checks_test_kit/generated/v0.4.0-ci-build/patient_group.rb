...
read succeeds.
      ...
      id :smart_health_checks_v040_ci_build_patient
      run_as_group
      ...
      test from: :smart_health_checks_v040_ci_build_patient_read_test
      test from: :smart_health_checks_v040_ci_build_patient_validation_test
      test from: :smart_health_checks_v040_ci_build_patient_must_support_test
    end
  end
end
