...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class QuestionnaireResponseGroup < Inferno::TestGroup
      title 'Questionnaire Response Tests'
      short_description 'Verify support for the server capabilities required by the Smart Health Checks Questionnaire Response.'
      description %(
  # Background

The Smart Health Checks Questionnaire Response sequence verifies that the system under test is
able to provide correct responses for QuestionnaireResponse queries. These queries
must contain resources conforming to the Smart Health Checks Questionnaire Response as
...
the [Smart Health Checks Questionnaire Response](https://smartforms.csiro.au/ig/StructureDefinition/SHCQuestionnaireResponse). Each element is checked against
...
read succeeds.
      ...
      id :smart_health_checks_v040_ci_build_questionnaire_response
      run_as_group
      ...
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_patient_search_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_questionnaire_search_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_status_search_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_patient_questionnaire_search_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_patient_status_search_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_read_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_validation_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_must_support_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_reference_resolution_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_create_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_update_update_test
      test from: :smart_health_checks_v040_ci_build_questionnaire_response_update_new_update_test
    end
  end
end
