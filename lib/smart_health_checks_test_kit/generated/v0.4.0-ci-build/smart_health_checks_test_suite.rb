  ...
  module SmartHealthChecksV040_CI_BUILD
    class SmartHealthChecksTestSuite < Inferno::TestSuite
      ...
      fhir_resource_validator do
        igs '/home/igs/0.4.0-ci-build.tgz'
        message_filters = [
      ...
      id :smart_health_checks_v040_ci_build
      ...
      group do
        ...
        id :smart_health_checks_v040_ci_build_fhir_api

        group from: :smart_health_checks_v040_ci_build_patient

        group from: :smart_health_checks_v040_ci_build_allergy_intolerance

        group from: :smart_health_checks_v040_ci_build_shc_condition

        group from: :smart_health_checks_v040_ci_build_immunization

        group from: :smart_health_checks_v040_ci_build_medication_statement

        group from: :smart_health_checks_v040_ci_build_shc_blood_pressure

        group from: :smart_health_checks_v040_ci_build_shc_body_height

        group from: :smart_health_checks_v040_ci_build_shc_body_weight

        group from: :smart_health_checks_v040_ci_build_shc_head_circumference

        group from: :smart_health_checks_v040_ci_build_shc_heart_rate

        group from: :smart_health_checks_v040_ci_build_shc_heart_rhythm

        group from: :smart_health_checks_v040_ci_build_shc_pathology_result

        group from: :smart_health_checks_v040_ci_build_shc_smoking_status

        group from: :smart_health_checks_v040_ci_build_shc_waist_circumference

        group from: :smart_health_checks_v040_ci_build_questionnaire_response

        group from: :smart_health_checks_v040_ci_build_encounter

        group from: :smart_health_checks_v040_ci_build_practitioner
