...
require_relative 'shc_heart_rhythm/shc_heart_rhythm_patient_code_search_test'
...
require_relative 'shc_heart_rhythm/shc_heart_rhythm_create_test'
...
read succeeds.
      ...
      id :smart_health_checks_v040_ci_build_shc_heart_rhythm
      run_as_group
      ...
      test from: :smart_health_checks_v040_ci_build_shc_heart_rhythm_patient_search_test
      test from: :smart_health_checks_v040_ci_build_shc_heart_rhythm_code_search_test
      test from: :smart_health_checks_v040_ci_build_shc_heart_rhythm_patient_code_search_test
      test from: :smart_health_checks_v040_ci_build_shc_heart_rhythm_validation_test
      test from: :smart_health_checks_v040_ci_build_shc_heart_rhythm_must_support_test
      test from: :smart_health_checks_v040_ci_build_shc_heart_rhythm_reference_resolution_test
      test from: :smart_health_checks_v040_ci_build_shc_heart_rhythm_create_test
    end
  end
end
