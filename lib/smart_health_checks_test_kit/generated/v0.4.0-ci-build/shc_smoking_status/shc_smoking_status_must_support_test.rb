...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class ShcSmokingStatusMustSupportTest < Inferno::Test
      ...
      description %(
        ...
        * Observation.code.coding:loincSmokingStatus
      ...
      id :smart_health_checks_v040_ci_build_shc_smoking_status_must_support_test
