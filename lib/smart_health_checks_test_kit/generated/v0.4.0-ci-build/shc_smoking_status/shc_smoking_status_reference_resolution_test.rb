...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class ShcSmokingStatusReferenceResolutionTest < Inferno::Test
      ...
      id :smart_health_checks_v040_ci_build_shc_smoking_status_reference_resolution_test
