...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class ShcHeadCircumferenceMustSupportTest < Inferno::Test
      ...
      description %(
        ...
        * Observation.code
        * Observation.code.coding:HeadCircumCode
        * Observation.code.coding:snomedHeadCircumCode
      ...
      id :smart_health_checks_v040_ci_build_shc_head_circumference_must_support_test
