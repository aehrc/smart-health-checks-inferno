...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class ShcConditionGroup < Inferno::TestGroup
      title 'Condition Tests'
      short_description 'Verify support for the server capabilities required by the Smart Health Checks Condition.'
      description %(
  # Background

The Smart Health Checks Condition sequence verifies that the system under test is
able to provide correct responses for Condition queries. These queries
must contain resources conforming to the Smart Health Checks Condition as
...
the [Smart Health Checks Condition](https://smartforms.csiro.au/ig/StructureDefinition/SHCCondition). Each element is checked against
...
read succeeds.
      ...
      id :smart_health_checks_v040_ci_build_shc_condition
      run_as_group
      ...
      test from: :smart_health_checks_v040_ci_build_shc_condition_patient_search_test
      test from: :smart_health_checks_v040_ci_build_shc_condition_category_search_test
      test from: :smart_health_checks_v040_ci_build_shc_condition_patient_category_search_test
      test from: :smart_health_checks_v040_ci_build_shc_condition_validation_test
      test from: :smart_health_checks_v040_ci_build_shc_condition_must_support_test
      test from: :smart_health_checks_v040_ci_build_shc_condition_reference_resolution_test
      test from: :smart_health_checks_v040_ci_build_shc_condition_create_test
      test from: :smart_health_checks_v040_ci_build_shc_condition_fhirpath_json_patch_test
    end
  end
end
