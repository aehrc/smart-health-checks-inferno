...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class PatientValidationTest < Inferno::Test
      ...
      id :smart_health_checks_v040_ci_build_patient_validation_test
      title 'Patient resources returned during previous tests conform to the Smart Health Checks Patient'
      description %(
This test verifies resources returned from the first search conform to
the [Smart Health Checks Patient](https://smartforms.csiro.au/ig/StructureDefinition/SHCPatient).
