...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class AllergyIntoleranceGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the server capabilities required by the Smart Health Checks AllergyIntolerance.'
      description %(
  # Background

The Smart Health Checks AllergyIntolerance sequence verifies that the system under test is
able to provide correct responses for AllergyIntolerance queries. These queries
must contain resources conforming to the Smart Health Checks AllergyIntolerance as
...
the [Smart Health Checks AllergyIntolerance](https://smartforms.csiro.au/ig/StructureDefinition/SHCAllergyIntolerance). Each element is checked against
...
read succeeds.
      ...
      id :smart_health_checks_v040_ci_build_allergy_intolerance
      run_as_group
      ...
      test from: :smart_health_checks_v040_ci_build_allergy_intolerance_patient_search_test
      test from: :smart_health_checks_v040_ci_build_allergy_intolerance_validation_test
      test from: :smart_health_checks_v040_ci_build_allergy_intolerance_must_support_test
      test from: :smart_health_checks_v040_ci_build_allergy_intolerance_reference_resolution_test
      test from: :smart_health_checks_v040_ci_build_allergy_intolerance_create_test
      test from: :smart_health_checks_v040_ci_build_allergy_intolerance_fhirpath_json_patch_test
    end
  end
end
