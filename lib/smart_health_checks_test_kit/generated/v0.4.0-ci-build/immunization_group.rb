...
read succeeds.
      ...
      id :smart_health_checks_v040_ci_build_immunization
      run_as_group
      ...
      test from: :smart_health_checks_v040_ci_build_immunization_patient_search_test
      test from: :smart_health_checks_v040_ci_build_immunization_status_search_test
      test from: :smart_health_checks_v040_ci_build_immunization_patient_status_search_test
      test from: :smart_health_checks_v040_ci_build_immunization_validation_test
      test from: :smart_health_checks_v040_ci_build_immunization_must_support_test
      test from: :smart_health_checks_v040_ci_build_immunization_reference_resolution_test
      test from: :smart_health_checks_v040_ci_build_immunization_create_test
    end
  end
end
