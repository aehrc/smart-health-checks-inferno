...
module SmartHealthChecksTestKit
  module SmartHealthChecksV040_CI_BUILD
    class ShcBodyWeightMustSupportTest < Inferno::Test
      ...
      description %(
        ...
        * Observation.code.coding:snomedBodyWeightCode
      ...
      id :smart_health_checks_v040_ci_build_shc_body_weight_must_support_test
