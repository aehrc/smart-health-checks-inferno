...
read succeeds.
      ...
      test from: :smart_health_checks_v030_draft_shc_heart_rhythm_patient_code_search_test
      ...
      test from: :smart_health_checks_v030_draft_shc_heart_rhythm_create_test
    end
  end
end
