...
read succeeds.
      ...
      id :smart_health_checks_v030_draft_shc_blood_pressure
      run_as_group
      ...
      test from: :smart_health_checks_v030_draft_shc_blood_pressure_patient_code_search_test
      ...
      test from: :smart_health_checks_v030_draft_shc_blood_pressure_create_test
    end
  end
end
