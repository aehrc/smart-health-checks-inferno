...
module SmartHealthChecksTestKit
  module SmartHealthChecksV030_DRAFT
    class AllergyIntolerancePatchTest < Inferno::Test
      include InfernoSuiteGenerator::PatchTest

      title '(SHALL) Server returns correct AllergyIntolerance resource from AllergyIntolerance patch interaction'
      description 'A server SHALL support the AllergyIntolerance patch interaction.'

      id :smart_health_checks_v030_draft_allergy_intolerance_patch_test
